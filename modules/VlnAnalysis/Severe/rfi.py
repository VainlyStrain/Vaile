...
def test(web0, web):
    ...
    if (('=' in str(web0)) and ('?' in str(web0))):
        ...
        payload = 'https://raw.githubusercontent.com/VainlyStrain/Vaile/master/files/payload-db/json_payloads.lst'
        ...
        if '''{"__class":"null","A":"B"}''' in str(pm) and '''{"toJSON":"while(1);"}''' in str(pm):
            ...
            if (('=' in str(web0)) and ('?' in str(web0))):
                ...
                payload1 = 'https://raw.githubusercontent.com/VainlyStrain/Vaile/master/files/payload-db/json_payloads.lst%00'
