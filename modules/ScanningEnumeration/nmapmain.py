...
info = "Vaile frontend to the NMap scanner."
    ...
    def nmapsx(web):
        try:
            ...
            if q == "y":
                ...
                time.sleep(0.05)
                print(""+C+"                        [99] \033[94mBack to the Vaile Shell")
                time.sleep(0.05)
                print('')
                print(''+GR+'                      +=====================================================+')
                print('')
                ...
                if main == "1":
                    ...
                    print(""+C+"                        [!] Back to the Vaile shell")
                    print('')
                else:
                ...
                print(""+C+"                        [15] \033[94mDiscover Web-Applications in use")
                time.sleep(0.1)
                print(""+C+"                        [16] \033[94mBack to the Vaile Shell")
                time.sleep(0.1)
                print('')
                print(''+GR+'                      +=====================================================+')
                time.sleep(0.2)
